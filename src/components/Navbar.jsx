...
import { useMockServices } from "../mocks/mockServiceProvider.jsx";
...
const Navbar = () => {
  ...
  // Use the mock service provider instead of local state
  const { isAuthenticated, logout, cart } = useMockServices();
  ...
  const handleLogout = () => {
    logout(); // Use the logout function from mock service
    handleUserMenuClose();
    navigate("/login");
  };
